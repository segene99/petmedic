	...
	<div class="container-fluid">
		...
		<div class="container structure">
			...
			<form name="fm" action="updateReview" method="post"
					...
					<div class=" row upper-box-rev">
						...
						<div class="col-9 text-rev-box-right">
							<div class="text-rev-box-right-inner">
								<input class="textareabordergray" type="text" style="width: 100%;"
				...
				<div class="text-center content-box-rev" style="color: gray">*리뷰수정 시, 상단의 제목과
					내용을 클릭하여 수정해주세요</div>
