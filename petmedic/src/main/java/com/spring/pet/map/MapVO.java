...
public class MapVO {
	...
	private String mapTimeOption; /*검색조건(즉시예약*/
	private LocalDate hos_date_now;  /* 현재날짜 */
	private LocalTime hos_time_now;  /* 현재시간  */
	...
	public LocalDate getHos_date_now() {
		return hos_date_now;
	}
	public void setHos_date_now(LocalDate hos_date_now) {
		this.hos_date_now = hos_date_now;
	}
	public LocalTime getHos_time_now() {
		return hos_time_now;
	}
	public void setHos_time_now(LocalTime hos_time_now) {
		this.hos_time_now = hos_time_now;
	}
	public String getMapTimeOption() {
		return mapTimeOption;
	}
	public void setMapTimeOption(String mapTimeOption) {
		this.mapTimeOption = mapTimeOption;
	}
	...
	public String toString() {
		return "MapVO [hos_id=" + hos_id + ", hos_name=" + hos_name + ", hos_pw=" + hos_pw + ", hos_addr=" + hos_addr
				+ ", hos_addr2=" + hos_addr2 + ", hos_addr3=" + hos_addr3 + ", hos_addr4=" + hos_addr4 + ", hos_addr5="
				+ hos_addr5 + ", hos_tel=" + hos_tel + ", hos_start=" + hos_start + ", hos_end=" + hos_end
				+ ", hos_s_lunch=" + hos_s_lunch + ", hos_e_lunch=" + hos_e_lunch + ", hos_hol=" + hos_hol
				...
				+ searchCondition + ", mapTimeOption=" + mapTimeOption + ", hos_date_now=" + hos_date_now
				+ ", hos_time_now=" + hos_time_now + ", uploadFile=" + uploadFile + ", uploadFile1=" + uploadFile1
				+ ", filename=" + filename + ", hos_file=" + hos_file + ", hos_pic=" + hos_pic + ", multi=" + multi
				+ ", latitude=" + latitude + ", longitude=" + longitude + ", getHos_date_now()=" + getHos_date_now()
				+ ", getHos_time_now()=" + getHos_time_now() + ", getMapTimeOption()=" + getMapTimeOption()
				+ ", getHos_id()=" + getHos_id() + ", getHos_name()=" + getHos_name() + ", getHos_pw()=" + getHos_pw()
				+ ", getHos_addr()=" + getHos_addr() + ", getHos_addr2()=" + getHos_addr2() + ", getHos_addr3()="
				+ getHos_addr3() + ", getHos_addr4()=" + getHos_addr4() + ", getHos_addr5()=" + getHos_addr5()
				+ ", getHos_tel()=" + getHos_tel() + ", getHos_start()=" + getHos_start() + ", getHos_end()="
				+ getHos_end() + ", getHos_s_lunch()=" + getHos_s_lunch() + ", getHos_e_lunch()=" + getHos_e_lunch()
				+ ", getHos_hol()=" + getHos_hol() + ", getHos_cate()=" + getHos_cate() + ", getHos_role()="
				+ getHos_role() + ", getHos_star()=" + getHos_star() + ", getHos_date()=" + getHos_date()
				+ ", getHos_price()=" + getHos_price() + ", getHos_del()=" + getHos_del() + ", getHos_url()="
				+ getHos_url() + ", getHos_new_date()=" + getHos_new_date() + ", getSearchKeyword()="
				+ getSearchKeyword() + ", getSearchCondition()=" + getSearchCondition() + ", getUploadFile()="
				+ getUploadFile() + ", getUploadFile1()=" + getUploadFile1() + ", getFilename()=" + getFilename()
				+ ", getHos_file()=" + getHos_file() + ", getHos_pic()=" + getHos_pic() + ", getMulti()=" + getMulti()
				+ ", getLatitude()=" + getLatitude() + ", getLongitude()=" + getLongitude() + ", getClass()="
